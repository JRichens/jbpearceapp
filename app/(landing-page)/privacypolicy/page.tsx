const PrivacyPolicy = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p>
        {`J B Pearce App ("we", "us", or "our") operates the https://jbpearce.app/ (hereinafter referred to as the "Service"). Our Service
        provides users with information about the cars available at our scrap
        yard. This Privacy Policy informs you of our policies regarding the
      ...
      <p>
        ...
        accordance with this policy. We are committed to maintaining the trust
        and confidence of all visitors to our web application.
      </p>
      ...
      <p>J B Pearce App uses the collected data for various purposes:</p>
      <ul className="list-disc list-inside mb-4">
      ...
      <h3 className="text-xl font-bold mt-6 mb-2">Transfer of Data</h3>
      <p>
      ...
      <p>
        We do not sell, share, or lease your Personal Data to third parties. We
        will only disclose your Personal Data in the following scenarios:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of J B Pearce App</li>
        <li>
      ...
      <p>By email: sales@jbpearce.co.uk</p>
    </div>
  )
}
