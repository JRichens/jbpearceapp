            ...
            <div className="bg-white rounded shadow-lg m-4 max-h-[65vh] overflow-hidden overflow-y-auto">
                ...
                <div className="px-4 pb-4">
                    <div className="flex flex-row gap-4">
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    setPolygonActivityCode(e.target.value)
                                }
                                placeholder=""
                    ...
                    <div className="flex flex-row items-center gap-3">
                        <div>
                            <Label htmlFor="hectares" className="block mb-1">
                                Hectares
                            </Label>
                            <Input
                                type="text"
                                id="area"
                                value={parseFloat(polygonHectares)
                                    .toFixed(2)
                                    .toString()}
                                onChange={(e) =>
                                    setPolygonHectares(e.target.value)
                                }
                                className="text-lg w-[70px] border border-gray-300 rounded px-2 py-1 mb-2"
                            />
                        </div>
                        <div>
                            <Label htmlFor="acres" className="block mb-1">
                                Acres
                            </Label>
                            <Input
                                type="text"
                                id="acres"
                                value={parseFloat(polygonAcres)
                                    .toFixed(2)
                                    .toString()}
                                onChange={(e) =>
                                    setPolygonAcres(e.target.value)
                                }
                                className="text-lg w-[70px] border border-gray-300 rounded px-2 py-1 mb-2"
                            />
                        </div>
                        <div>
                            <Label htmlFor="SBIno" className="block mb-1">
                                SBI No.
                            </Label>
                            <Input
                                type="text"
                                ...
                                value={polygonSBIno}
                                onChange={(e) =>
                                    setPolygonSBIno(e.target.value)
                                }
                                className="text-lg w-[150px] border border-gray-300 rounded px-2 py-1 mb-2"
                            />
                        </div>
                    </div>
                    <Label htmlFor="colour" className="block mb-1">
                        Colour
                    </Label>
                    <GithubPicker
